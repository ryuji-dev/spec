...
const v = toFeedPostView(
  { id: "b1", category: "토론", title: "출석 감소 고민", excerpt: "요약", viewCount: 1843, createdAt: new Date("2026-05-30T00:00:00Z"), authorName: "김도현", authorChurch: "서경중앙교회", commentCount: 47, likeCount: 128 },
  now,
);
