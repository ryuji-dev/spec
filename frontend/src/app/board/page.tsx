...
/**
 * 자유게시판 (mock 데이터, 인터랙션 포함).
 * 원본 디자인:
 *   _design/seogyeong-presbytery-education-committee/project/서경노회 자유게시판.html
 *   _design/.../community.jsx
...
export default async function BoardPage() {
  ...
  return <BoardMobile deviceType={device} />;
}
