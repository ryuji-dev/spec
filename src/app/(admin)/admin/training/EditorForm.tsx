...
import type { PostFormState } from "@/server/actions/training";
...
export default function EditorForm({
  ...
  return (
    <form action={formAction} className={styles.formGrid} style={{ maxWidth: 640 }}>
      ...
      <select name="category" defaultValue={initial?.category ?? TRAINING_CATEGORIES_KO[0]} className={styles.input}>
        {TRAINING_CATEGORIES_KO.map((c) => (
