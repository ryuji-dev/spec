...
import { deletePost, togglePublished } from "@/server/actions/training";
  ...
  return (
    <div className={styles.page}>
      <div className={styles.headerRow}>
        <h1 className={styles.pageTitle}>강습회 글 관리</h1>
        <Link href="/admin/training/new" className={styles.btnGhost}>
          + 새 글
        </Link>
      </div>
              ...
              <tr key={r.id}>
                ...
                <td>
                  <span className={styles.rowActions}>
                    <Link href={`/admin/training/${r.id}/edit`} className={styles.rowLink}>수정</Link>
